...
@Component
public class UserFormValidator extends BaseValidator implements Validator {
	...
	public boolean supports(Class<?> clazz) {
		return PosUser.class.equals(clazz);
	}

	@Override
	public void validate(Object target, Errors errors) {

		PosUser user = (PosUser) target;

		//ValidationUtils.rejectIfEmptyOrWhitespace(errors, "name", "NotEmpty.userForm.name");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "email", "NotEmpty.userForm.email");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "address1", "NotEmpty.userForm.address");
